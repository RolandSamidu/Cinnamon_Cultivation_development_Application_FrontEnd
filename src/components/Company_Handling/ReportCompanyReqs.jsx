...
export default class ReportCompanyReqs extends Component {
    constructor(props) {
        super(props);
                    ...
                    <main>
                        <div class="head-title">
                            ...
                            <ReactToPrint
                                ...
                                documentTitle='All Companies Request Report'
                                pageStyle="print"
                            />
                        </div>
                                        ...
                                        <div className="col-sm-6 mt-3">
                                            <div className="card">
                                                <div className="card-body text-center">
                                                    ...
                                                    <h6>Tel : {companyrequirements.companyMobile} | Date : {companyrequirements.date}</h6>
